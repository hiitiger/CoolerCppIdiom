...
public:
    ...
    static DateTime fromUTCTimeStamp(uint32_t sec);
    static DateTime fromTimeStamp(uint32_t sec);
...
inline DateTime DateTime::fromUTCTimeStamp(uint32_t sec)
{
    DateTime dateTime;
    time_t curtime = sec;
    std::tm buf;
...
inline DateTime DateTime::fromTimeStamp(uint32_t sec)
{
    DateTime dateTime;
    time_t curtime = sec;
    std::tm buf;
